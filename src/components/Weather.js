...
const DisplayWeatherSheet = (props) => {
  const {current, forecast, isRequesting, onReset} = props;
  return <div className="app__weather">
            <div className="app__current">
              <CurrentWeather {...current} onReset={onReset}/>
            </div>
          </div>;
}

const DisplayLoaderSheet = (props) => {
  const preloaderStyle = { opacity: 1 };
  const sunStyle = {
    opacity: 1,
    marginLeft: 0,
    marginTop: 0
  ...
  return <div className="preloader" style={preloaderStyle}>
          <svg version="1.1" className="sun" x="0px" y="0px" width="10px" height="10px" viewBox="0 0 10 10" enable-background="new 0 0 10 10" style={sunStyle}>
           ...
           <svg version="1.1" className="cloud" x="0px" y="0px" width="10px" height="10px" viewBox="0 0 10 10" enable-background="new 0 0 10 10">
...
const WeatherDisplay = (props) => {
  return props.current ? DisplayWeatherSheet(props) : DisplayLoaderSheet(props);
}
